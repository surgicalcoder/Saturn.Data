...
public record struct EntityId : IComparable<EntityId>, IEquatable<EntityId>, IConvertible
{
    ...
    /// </summary>
    public static EntityId Empty { get; } = default;
    ...
    // public operators
    /// <summary>
    /// Implicitly converts a string to an EntityId.
    /// </summary>
    ...
    /// <returns>An ObjectId.</returns>
    public static EntityId GenerateNewId(DateTime timestamp)
    {
    ...
    /// <returns>An ObjectId.</returns>
    public static EntityId GenerateNewId(int timestamp)
    {
    ...
    /// </summary>
    /// <param name="s">The string value.</param>
    /// <param name="entityId">The new ObjectId.</param>
    ...
    {
        var secondsSinceEpoch = (long)Math.Floor((timestamp.ToUniversalTime() - UnixEpoch).TotalSeconds);
    ...
    /// <returns>A 32-bit signed integer that indicates whether this ObjectId is less than, equal to, or greather than the
    /// other.</returns>
