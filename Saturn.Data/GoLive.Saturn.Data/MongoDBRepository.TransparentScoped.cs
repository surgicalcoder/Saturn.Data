...
public partial class MongoDBRepository : ITransparentScopedRepository
{
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await InsertMany<TItem, TParent>(scope, entities, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await UpsertMany<TItem, TParent>(scope, entities, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await UpdateMany<TItem, TParent>(scope, entities, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await UpdateMany<TItem, TParent>(scope, entity, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await Delete<TItem, TParent>(scope, entity, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await DeleteMany<TItem, TParent>(scope, IDs, transaction, cancellationToken);
    }
    ...
    {
        var scope = options.TransparentScopeProvider.Invoke(typeof(TParent));
        await DeleteMany<TItem, TParent>(scope, entities, transaction, cancellationToken);
    }
}